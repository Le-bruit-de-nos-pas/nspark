...
ggsave(file = "../out/number_with_ecmp_icb.svg", plot = plot, width = 6, height = 4)
...
#   <chr>      <int> <int>   <dbl>
# 1 Amantadine    98    14    14.3
# 2 Placebo      106    15    14.2
...
length(unique(incident_icb_data$SUBJID)) # 175
...
# TREATMENT=Amantadine 84       24     23.9  0.000789   0.00169
# TREATMENT=Placebo    91       26     26.1  0.000720   0.00169
# 
...
# 
#   n= 175, number of events= 50 
# 
#                     coef exp(coef) se(coef)      z Pr(>|z|)
# TREATMENTPlacebo -0.0134    0.9867   0.2831 -0.047    0.962
# 
#                  exp(coef) exp(-coef) lower .95 upper .95
# TREATMENTPlacebo    0.9867      1.013    0.5665     1.718
# 
# Concordance= 0.504  (se = 0.038 )
